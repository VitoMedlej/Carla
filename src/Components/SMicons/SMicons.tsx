...
const sm = [
    {
        ...
        href:'https://www.instagram.com/number1bycarla/'
    },
    {Icon:'https://cdn-icons-png.flaticon.com/128/1384/1384007.png',href:'https://wa.me/+96171219846'},
...
const SMicons = ({sx,color}:{color?:string,sx?:any}) => {
  return (
    ...
    {sm.map((item)=>{
      return <Box  key={item.href}
       className='relative  flex center items-center justify-center space-between' 
       sx={{borderRadius:'50%',width:'40px',mx:.35,mt:1,height:'40px'}}>
